...
exchange_config = config['EXCHANGES'].get('KUCOIN') or {}
...
class Bot:
    ...
    def close_position(self, symbol):
        ...
        if amount <= 0:
            print("No KuCoin balance available to close for " + base_currency)
            return None
